...
import io.netnotes.resources.javafxsvg.SvgImageLoaderFactory;
...
public class ResourceFactory {
    ...
    static{
        ...
        Font.loadFont(ResourceFactory.class.getResource(PRIMARY_FONT).toExternalForm(),16);
        Font.loadFont(ResourceFactory.class.getResource(EMOJI_FONT).toExternalForm(),20);
    ...
    public static void initAwtOcrFont(){
        ...
        try( 
            InputStream stream = ResourceFactory.class.getResource(PRIMARY_FONT).openStream(); 
        ) {
    ...
    public static String getStringFromResource(String resourceLocation) throws IOException{
        URL location = resourceLocation != null ? ResourceFactory.class.getResource(resourceLocation) : null;
        if(location != null){
            try(
